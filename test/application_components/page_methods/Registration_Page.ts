...
readonly Edit_pencil_icon:Locator;
...
this.emt_homepage_reporting = this.page.getByText('Reporting', { exact: true });
    ...
    this.Checkbox=this.page.locator("//span[text() =' Would you like to set same Fundraising Target for all the distances? ']")
    ...
    this.Fundraising_fees=this.page.locator("//input[@placeholder='How much would you like to set your fundraising target?']")
...
this.published_box=this.page.locator("//*[contains(text(),'Published')]")
 ...
 this.checkbox_registration_fee=this.page.locator("//span[text() =' Would you like to set same Registration Fee for all the distances? ']");
...
async verify_edit_reg_autopopulated_fields(){
  ...
  await this.playwrightFactory.click(this.page.getByRole('cell', { name: strPage })
  );
}
