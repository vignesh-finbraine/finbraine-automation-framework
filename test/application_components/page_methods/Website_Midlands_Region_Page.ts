...
export class WEBSITE_MIDLANDS_REGIONS_PAGE {
  private page: Page;
...
readonly txt_Midlands_Title: Locator;
readonly txt_Associated_Events:Locator;
  ...
  constructor(container: any) {
    ...
    this.txt_Midlands_Title=this.page.locator("//h1[normalize-space()='Midlands']")
  ...
  async user_verify_midlands_title(){

    await expect(this.txt_Midlands_Title).toBeVisible();

  }
 
  async user_verify_associated_events(){

    await this.playwrightFactory.click(this.txt_Associated_Events);
