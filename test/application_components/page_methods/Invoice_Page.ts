...
readonly Invoice_table: Locator;
...
this.Invoice_table= this.page.locator("//*[contains(text(),'Invoices')]/ancestor::component-table//table");
...
await this.playwrightFactory.click(this.AsParticipant_pay)
 ...
 async user_verify_invoice_table(){
  await expect(this.Invoice_table).toBeVisible();
}
